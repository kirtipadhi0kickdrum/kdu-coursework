...
public class RoomControllerTest {
    ...
    public static void addRoomByAdmin(MockMvc mockMvc) throws Exception {
        try {
            ...
            // Check if "id" field is present, use a default value if not
            String houseId = houseData.containsKey("id") ? houseData.get("id").toString() : "defaultHouseId";

            mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/room")
                            .param("houseId", houseId)  // Check that this corresponds to your controller's expected format
